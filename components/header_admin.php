<div class="header-container">
  ...
  <form class="navbar" method="GET">
      ...
      <button class="navbar-menu navbar-middle" name="page" value="showfeedback">Show Feedback</button>
      <button class="navbar-menu navbar-middle" name="page" value="moviepage">Movie</button>
      <button class="navbar-menu navbar-right" name="page" value="addmovie">Add Movie</button>
  </form>
</div>